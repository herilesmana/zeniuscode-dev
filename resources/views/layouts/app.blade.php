            ...
            <div class="gtco-container">
                <div class="row">
                    <div class="col-sm-2 col-xs-12">
                        <div id="gtco-logo">
                            <a href="index.html"><img src="/images/logo.png" alt="Free HTML5 Website Template by FreeHTML5.co"></a>
                        </div>
                    </div>
            ...
            <div class="gtco-container">
                ...
                <div class="row row-pb-md">
                    <div class="col-md-4 col-sm-4">
                        ...
                        <img src="images/img_1.jpg" class="hidden" alt="Free HTML5 Website Template by FreeHTML5.co"></a><a href="#" class="gtco-item two-row bg-img animate-box" style="background-image: url(/images/img_2.jpg)">
                        <div class="overlay">
                            <i class="ti-arrow-top-right"></i>
                            <div class="copy">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <img src="images/img_3.jpg" class="hidden" alt="Free HTML5 Website Template by FreeHTML5.co"></a><a href="#" class="gtco-item two-row bg-img animate-box" style="background-image: url(images/img_4.jpg)">
                        <div class="overlay">
                            <i class="ti-arrow-top-right"></i>
                            <div class="copy">
